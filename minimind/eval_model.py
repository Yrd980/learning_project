...
def main():
    ...
    parser.add_argument(
        "--load", default=0, type=int, help="0: torch weight，1: transformers load"
    )
    parser.add_argument(
        "--model_mode",
        default=1,
        type=int,
        help="0: Pretrain，1: SFT-Chat，2: RLHF-Chat，3: Reason，4: RLAIF-Chat",
    )
    ...
    test_mode = int(input("[0] auto test\n[1] manual test\n"))
